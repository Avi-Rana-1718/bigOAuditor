    ...
    return (
        <footer className="p-3">
            ...
            <small className="text-[#888]">
                Build for the <a className="text-[#8a8f4a] hover:underline" href="https://developer.chrome.com/blog/ai-challenge">Google Chrome Built-in AI Challenge</a> using Chrome build-in AI APIs.<br />Check the <a href="" className="underline">Github</a>
            </small>
        </footer>
    )
}